...
// Source: github.com/NatdanaiKhe/simplebank/service (interfaces: TransferService)
//
// Generated by this command:
//
//	mockgen -package=mock -destination=./api/mock/TransferService.go github.com/NatdanaiKhe/simplebank/service TransferService
//
...
func (m *MockTransferService) CreateTransfer(ctx context.Context, param db.CreateTransferParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTransfer", ctx, param)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateTransfer indicates an expected call of CreateTransfer.
func (mr *MockTransferServiceMockRecorder) CreateTransfer(ctx, param any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTransfer", reflect.TypeOf((*MockTransferService)(nil).CreateTransfer), ctx, param)
}
